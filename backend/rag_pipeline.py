...
class RAGPipeline:
    ...
    def ingest_documents(self) -> int:
        """
        Load all .txt files from DATA_PATH, chunk them, embed them,
    ...
    def chat(
        ...
        Args:
            ...
            chat_history: List of (human, ai) string tuples from
        ...
        """
        # Convert tuple pairs → LangChain message objects
        lc_history = []
    ...
    def get_collection_count(self) -> int:
        """Return the number of chunks in ChromaDB."""
        if self.vectorstore:
